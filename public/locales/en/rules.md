...
MEMORY SYSTEM:
- memory: What Bilbo will remember from his perspective (briefly) - names, key details from EVENT and Bilbo's reactions
...
JSON RESPONSE FORMAT:
{
    ...
    "newTask": [],
    "newHealth": "",
    "newTime": {"day": number, "month": "name", "year": number, "era": "epoch", "time": "hour:minute"},
    "newEnvironment": [],
